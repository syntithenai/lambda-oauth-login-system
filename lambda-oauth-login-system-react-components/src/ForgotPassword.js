        ...
        let that = this
         ...
         { this.props.hideButtons !== true  && <Link to={this.props.linkBase + "/login"} style={{clear:'both',display:'inline'}} ><div style={{float:'right', marginRight:'0.3em',marginLeft:'0.5em'}} className='btn btn-primary' >Login</div></Link>}
          ...
          <fieldset className='col-12' >
				...
				<br/>
				<br/>
				{ !this.state.submitted && <button className="btn btn-lg btn-success btn-block" type="submit">Send Recovery Email</button>  }
				{ this.state.submitted && <button className="btn btn-lg btn-danger btn-block" type="submit">Resend Recovery Email</button>  }
