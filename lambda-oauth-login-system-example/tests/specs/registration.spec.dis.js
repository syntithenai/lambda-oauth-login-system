...
bs.TARGETS[ "NAV_REGISTER_BUTTON" ] = async () => await bs.query( "#register_button", true, "NAV_REGISTER_BUTTON" );
bs.TARGETS[ "REGISTRATION_CONFIRMATION" ] = async () => await bs.query( "#registrationform h3", true, "REGISTRATION_CONFIRMATION" );
