...
const QuestionList = function(props) {
	...
	const endpoint = useLocalForageAndRestEndpoint(Object.assign({},props,{
		restUrl:props.restUrl ? props.restUrl : '/dev/handler/rest/api/v1/'
	}))
	
	console.log(props.reviewApi.userTopics)
	if (topic) {
		return <ItemList {...props}  endpoint={endpoint} categorySearchFilter={topic} setCategorySearchFilter={setTopic} />
	} else {
