...
import {generateObjectId, decodeFromBase64} from '../helpers'
...
export default function MediaEditorComponent(props) {
	...
	return	(<div style={{marginTop:'0.5em', borderTop:'1px solid grey', clear:'both'}}>
			...
			return <div style={{marginTop:'0.5em', clear:'both'}} key={buttonKey}>
				...
				<label>&nbsp;&nbsp;&nbsp;Autoplay ?&nbsp;&nbsp; 
				{!props.readOnly && <CheckboxComponent value={button.autoplay === "yes" ? true : false} onChange={function(e) {var newButton = button; newButton.autoplay = e ? 'yes' : 'no'; updateListItemData(buttonKey,newButton)}} />}
